...
> **What it demonstrates:** NLP embeddings · unsupervised clustering · time-series & LSTM forecasting · working at 5.6M-row scale · rigorous held-out (locked future-window) validation · Python.
